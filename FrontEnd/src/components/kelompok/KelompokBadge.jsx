...
export default function KelompokBadge({ kelompokName }) {
  ...
  return (
    <div className="bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200 rounded-lg px-4 py-3 shadow-sm inline-flex items-center gap-3">
